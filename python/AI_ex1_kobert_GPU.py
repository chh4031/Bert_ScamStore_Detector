...
model_Name = 'skt/kobert-base-v1'  # 모델 이름

# CSV 경로가 다를 경우 쓰는법 - 추가
file_path = r'C:\Users\Slim7\Desktop\data\DATA_1000.csv'

# CSV 파일 읽는 부분 추가 => 외부 데이터 셋 가져오기(CSV 형식) - 추가
...
# AI_ex1.py랑 같은 코드지만 kobert 사용된 거만 다름
# 파이썬 3.11 버전 가상환경에서 실행할것.